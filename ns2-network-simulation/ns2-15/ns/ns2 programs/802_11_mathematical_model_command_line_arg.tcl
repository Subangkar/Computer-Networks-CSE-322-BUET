...
set nm 802_11_math_model.nam
set tr /home/ubuntu/ns2\ programs/raw_data/802_11_math_model.tr
set topo_file topo_802_11_math_model.txt
# 
# Initialize ns
#
...
$ns_ at [expr $start_time+$time_duration +10] "finish"
#$ns_ at [expr $start_time+$time_duration +20] "puts \"NS Exiting...\"; $ns_ halt"
$ns_ at [expr $start_time+$time_duration +20] "$ns_ nam-end-wireless [$ns_ now]; puts \"NS Exiting...\"; $ns_ halt"
