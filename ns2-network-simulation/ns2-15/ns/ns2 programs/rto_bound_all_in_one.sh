...
output_file_format="rto_calculated_bound";
iteration_float=1.0;
...
min_rto=0.2
max_rto=39.523
#max: 36.058 39.523 43.475 55.332  
#min: 0.023 0.015
#default: 0.2, 60.0
...
ns 802_11_rto_bound.tcl $r $min_rto $max_rto
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk 802_11_grid_tcp_with_energy_random_traffic.tr > math_model1.out
awk -f rule_th_del_enr_tcp_only_data.awk /home/ubuntu/ns2\ programs/raw_data/802_11_rto_bound.tr > /home/ubuntu/ns2\ programs/raw_data/rto_bound_all.out
rm /home/ubuntu/ns2\ programs/raw_data/802_11_rto_bound.tr
...
#		echo -ne "energy_per_packet: "
	...
	echo "$val"
done < /home/ubuntu/ns2\ programs/raw_data/rto_bound_all.out
...
dir=""
under="_"
output_file="$dir$output_file_format$under$r$under$r$under$min_rto$under$max_rto.out"
