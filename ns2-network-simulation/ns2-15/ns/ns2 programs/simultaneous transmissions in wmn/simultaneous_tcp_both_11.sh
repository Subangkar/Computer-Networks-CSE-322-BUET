...
start_pckt_per_sec=1000
end_pckt_per_sec=1000

start_data_rate=5500000
end_data_rate=5500000
...
#                            CHNG PATH		1		######################################################
ns /home/ubuntu/ns2\ programs/simultaneous\ transmissions\ in\ wmn/simultaneous_tcp_both_11.tcl $r $p $pckt_size $pckt_per_sec $data_rate $range_11    # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
