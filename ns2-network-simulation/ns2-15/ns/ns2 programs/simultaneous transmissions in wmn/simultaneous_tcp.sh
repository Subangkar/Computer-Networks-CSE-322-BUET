...
start_pckt_per_sec=50
end_pckt_per_sec=50

start_data_rate=1000000
end_data_rate=1000000
...
dir="/home/ubuntu/ns2_data/simultaneous/raw_"
under="_"
...
#                            CHNG PATH		1		######################################################
ns /home/ubuntu/ns2\ programs/simultaneous\ transmissions\ in\ wmn/simultaneous_tcp.tcl $r $p $pckt_size $pckt_per_sec $data_rate $range_11    # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk 802_11_grid_tcp_with_energy_random_traffic.tr > math_model1.out
#                            CHNG PATH		2		######################################################
awk -f /home/ubuntu/ns2\ programs/simultaneous\ transmissions\ in\ wmn/rule_wireless_tcp.awk /home/ubuntu/ns2\ programs/raw_data/simultaneous.tr > /home/ubuntu/ns2\ programs/raw_data/simultaneous.out
