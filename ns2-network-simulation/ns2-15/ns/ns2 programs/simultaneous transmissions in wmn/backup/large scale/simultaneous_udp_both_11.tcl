...
set num_sink_to_node_flow [expr $num_row * $num_col * 25 / 100] ;#[expr $num_row+$num_col] ;# ;#[expr ($num_row+$num_col)/2] ;# as 2 flows are created per sink flow
...
set tr /home/kanchi/a/abmalima/raw_data/simultaneous_udp.tr
set topo_file /home/kanchi/a/abmalima/raw_data/topo_simultaneous_udp.txt
