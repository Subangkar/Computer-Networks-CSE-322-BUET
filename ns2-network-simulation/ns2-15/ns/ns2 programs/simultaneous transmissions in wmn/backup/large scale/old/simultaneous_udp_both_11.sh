...
output_file_format="simultaneous_udp";
...
#                            CHNG PATH		1		######################################################
#ns /home/ubuntu/ns2\ programs/simultaneous\ transmissions\ in\ wmn/simultaneous_udp_both_11.tcl $r $p $pckt_size $pckt_per_sec $data_rate $range_11 $num_sink     # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
ns simultaneous_udp_both_11.tcl $r $p $pckt_size $pckt_per_sec $data_rate $range_11 $num_sink     # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk 802_11_grid_tcp_with_energy_random_traffic.tr > math_model1.out
#                            CHNG PATH		2		######################################################
awk -f rule_wireless_udp_both_11.awk /home/kanchi/a/abmalima/raw_data/simultaneous_udp.tr > /home/kanchi/a/abmalima/raw_data/simultaneous_udp.out
...
#	l=$(($l+$inc))
	...
	echo "$val"
#                            CHNG PATH		3		######################################################
done < /home/kanchi/a/abmalima/raw_data/simultaneous_udp.out
