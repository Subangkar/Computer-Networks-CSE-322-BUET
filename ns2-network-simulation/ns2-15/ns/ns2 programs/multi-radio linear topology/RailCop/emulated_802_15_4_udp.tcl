...
set cbr_rate 11.0Mb
set pps [expr [lindex $argv 2]]
set cbr_pckt_per_sec $pps ;#10 ;#[lindex $argv 3] ;#100
set cbr_interval [expr 1.0/$cbr_pckt_per_sec] ;# ?????? 1 for 1 packets per second and 0.1 for 10 packets per second
#set cbr_interval [expr 1.0/[lindex $argv 3]] ;# ?????? 1 for 1 packets per second and 0.1 for 10 packets per second
#set cbr_interval [expr 1.0/$cbr_pckt_per_sec] ;# ?????? 1 for 1 packets per second and 0.1 for 10 packets per second
...
set x_dim 234 ; #[lindex $argv 1]
set y_dim 234 ; #[lindex $argv 1]
...
set val(idlepower_11) 56.4e-3		;#LEAP	(active power in spec)
set val(rxpower_11) 59.1e-3			;#LEAP
set val(txpower_11) 52.2e-3			;#LEAP
set val(sleeppower_11) 0.6e-3		;#LEAP
set val(transitionpower_11) 35.708e-3		;#LEAP: 
set val(transitiontime_11) 2.4e-3		;#LEAP
...
Mac/802_11 set dataRate_ .250Mb
...
set nm multi_radio_emulated_802_15_4_linear.nam
set tr /home/ubuntu/ns2\ programs/raw_data/multi_radio_emulated_802_15_4_linear.tr
set topo_file topo_multi_radio_emulated_802_15_4_linear.txt
