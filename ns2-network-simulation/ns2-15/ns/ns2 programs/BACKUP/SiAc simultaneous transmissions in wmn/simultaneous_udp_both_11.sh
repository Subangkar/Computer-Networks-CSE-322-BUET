...
#                            CHNG PATH		1		######################################################
ns /home/ubuntu/ns2\ programs/simultaneous\ transmissions\ in\ wmn/simultaneous_udp_both_11.tcl $r $p $pckt_size $pckt_per_sec $data_rate $range_11    # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
