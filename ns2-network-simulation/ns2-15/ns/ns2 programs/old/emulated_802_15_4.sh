...
output_file_format="multi_radio_emulated_802_15_4_random";
iteration_float=5.0;
...
#                            CHNG PATH		1		######################################################
ns /home/ubuntu/ns2\ programs/multi-radio\ random\ topology/emulated_802_15_4_udp.tcl $r # $dist_11 $pckt_size $pckt_per_sec $routing $time_sim
echo "SIMULATION COMPLETE. BUILDING STAT......"
#awk -f rule_th_del_enr_tcp.awk emulated_802_15_4_grid_tcp_with_energy_random_traffic.tr > math_model1.out
#                            CHNG PATH		2		######################################################
awk -f /home/ubuntu/ns2\ programs/multi-radio\ random\ topology/rule_wireless_udp.awk /home/ubuntu/ns2\ programs/raw_data/multi_radio_emulated_802_15_4_random.tr > /home/ubuntu/ns2\ programs/raw_data/multi_radio_emulated_802_15_4_random.out
...
#		echo -ne "energy_efficiency: "
	...
	echo "$val"
#                            CHNG PATH		3		######################################################
done < /home/ubuntu/ns2\ programs/raw_data/multi_radio_emulated_802_15_4_random.out
