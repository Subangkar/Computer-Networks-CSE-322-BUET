...
set nm multi_radio_emulated_802_15_4_random.nam
set tr /home/ubuntu/ns2\ programs/raw_data/multi_radio_emulated_802_15_4_random.tr
set topo_file topo_multi_radio_emulated_802_15_4_random.txt
...
#CHNG
for {set i 0} {$i < [expr $num_parallel_flow + $num_cross_flow + $num_random_flow + $num_sink_flow]} {incr i} {
