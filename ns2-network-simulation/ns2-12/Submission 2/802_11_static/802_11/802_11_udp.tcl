...
set num_row 3 ;#number of row
set num_col 3;#number of column
...
proc finish {} {
	puts "finishing"
	global ns_ tracefd topofile nm ;#namtrace 
	#global ns_ topofile
	$ns_ flush-trace
	close $tracefd
	#close $namtrace
